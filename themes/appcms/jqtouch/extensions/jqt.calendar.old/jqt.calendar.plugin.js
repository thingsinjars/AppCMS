...
<div id="any_id">
	<dl id="2011-01-25">
		<dt>07:30</dt><dd>Breakfast at Tiffany's</dd>
		<dt>12:15</dt><dd>Lunch</dd>
		<dt>17:50</dt><dd>Dinner with Mussolini</dd>
	</dl>
</div>
<script type="text/javascript">
	$('#any_id').getCalendar();
</script>
Defaults to today but can be called with a date.
*/
(function ($) {
  if ($.jQTouch) {
    $.jQTouch.addExtension(function calendar(jQT) {
      ...
      jQT.calendarSettings = {debug: true};
